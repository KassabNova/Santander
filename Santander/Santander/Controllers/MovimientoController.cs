...
namespace Santander.Controllers
{
    ...
    public class MovimientoController : ControllerBase
    {
        ...
        public RespuestaTransferencia Transferencia([FromBody] SolicitudTransferencia solicitud)
        {
            ...
            {
                if(solicitud.PagoTerceros)SantanderHelper.TransferenciaTerceros(solicitud.TarjetaOrigen, solicitud.Monto, solicitud.Detalle, out respuesta.ResultadoOperacion);
                else SantanderHelper.TransferenciaInterbancaria(solicitud.TarjetaOrigen, solicitud.TarjetaDestino, solicitud.Monto, solicitud.Detalle, out respuesta.ResultadoOperacion);
